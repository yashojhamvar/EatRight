...
public class MenuItemAdapter2 extends RecyclerView.Adapter<MenuItemAdapter2.DataObjectHolder> {
    ...
    public MenuItemAdapter2(Context con) {
        m_context = con;
        m_data = new ArrayList<RestMenuItem>();
        imgLoad = VolleySingleton.getInstance(con).getImageLoader();
    }

    public MenuItemAdapter2(Context con, ArrayList<RestMenuItem> data) {
        m_context = con;
        m_data = data;
        imgLoad = VolleySingleton.getInstance(con).getImageLoader();
    }
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DataObjectHolder(View itemView) {
            ...
            cal = (TextView) itemView.findViewById(R.id.date2);
            img   = (NetworkImageView) itemView.findViewById(R.id.img2);
